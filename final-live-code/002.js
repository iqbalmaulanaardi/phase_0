...
/*
Algoritma
1. Buat variabel counter diisi dengan 0 untuk menghitung jumlah numbers yang sudah muncul
2. Buat variabel ketemu diisi dengan false sebagai index apabila numSearch tidak ada di array numbers
3. lakukan step 3a sebanyak panjang numbers(numbers.length) dari i = 0 dengan incremen i = i+1
  3a. jika numbers index ke i sama dengan numSearch maka lakukan step 4a
    4a. incremen counter(counter++), lalu lakukan step 4b
    4b. jika counter samadengan yangKe maka lakukan step 5a
      5a. isi variabel ketemu dengan true lalu lakukan step 5b.
      5b. kembalikan nilai i(index 'numSearch' yang ke 'yangKe')
6. jika ketemu sama dengan false (numSearch tidak ketemu) maka kembalikan nilai -1      
*/
